...
let test_compress _ =
  assert_equal (compress [1; 1; 2; 1]) [1; 2; 1];
  assert_equal (compress [1; 1; 2; 1; 3; 4; 4; 4]) [1; 2; 1; 3; 4]
...
let test_selection_sort _ =
  assert_equal (selection_sort ["zebra"; "apple"; "banana"]) ["apple"; "banana"; "zebra"];
  assert_equal (selection_sort ["cat"; "dog"; "ant"]) ["ant"; "cat"; "dog"]
